...
public class TestSettingActivity extends InstrumentedActivity implements OnClickListener {
    ...
    private void setPushTime(){
        ...
        if (startime > endtime) {
            Toast.makeText(TestSettingActivity.this, "开始时间不能大于结束时间", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mEditor.commit();
        Toast.makeText(TestSettingActivity.this, R.string.setting_su, Toast.LENGTH_SHORT).show();
    }
